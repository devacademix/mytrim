                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('Add Notes'.tr, style: _sectionTitleStyle),
                        const SizedBox(height: 10),
                        Container(
                          width: double.infinity,
                          decoration: ThemeProvider.cardDecoration(),
                ...
                value.apiCalled == false
                    ? Row(
                        ...
                        children: [
                          ...
                          Text('Please Wait'.tr, style: const TextStyle(fontFamily: 'bold', color: ThemeProvider.textPrimary)),
                        ],
                      )
                    : ListTile(
                    ...
                    ? Padding(
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            height: 46,
                            width: double.infinity,
                            decoration: BoxDecoration(color: ThemeProvider.appColor, borderRadius: BorderRadius.circular(14)),
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Text(
