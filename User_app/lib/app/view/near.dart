                            ...
                            child: Column(
                              children: [
                                Padding(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text('Top Specialist'.tr, style: const TextStyle(fontSize: 16, fontFamily: 'semibold', color: ThemeProvider.textPrimary))]),
                                ),
                                SingleChildScrollView(
                                ...
                                Padding(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [Text('Top Salon'.tr, style: const TextStyle(fontSize: 16, fontFamily: 'semibold', color: ThemeProvider.textPrimary))]),
                                ),
                                Padding(
                                                              ...
                                                              children: [
                                                                Padding(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      Expanded(child: Text(item.name.toString(), overflow: TextOverflow.ellipsis, style: const TextStyle(fontSize: 15, fontFamily: 'semibold', color: ThemeProvider.textPrimary))),
                                                                      Row(
                                                                        children: [
