...
class _PackagesDetailsScreenState extends State<PackagesDetailsScreen> {
                    ...
                    SliverAppBar(
                      ...
                      leading: Padding(
                        ...
                        child: CircleAvatar(
                          ...
                          child: IconButton(icon: Icon(Icons.arrow_back, color: isShrink ? ThemeProvider.textPrimary : ThemeProvider.whiteColor, size: 18), onPressed: () => value.onBack()),
                        ),
                      ),
                                    ...
                                    (index) => Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Text(value.packagesDetails.services![index].price.toString(), style: const TextStyle(fontSize: 13, color: ThemeProvider.textSecondary, fontFamily: 'medium')),
                                        ],
                                      ),
                                    ),
                                  ),
  ...
  Widget _priceCard(PackagesDetailsController value) {
    final currencySide = Get.find<PackagesDetailsController>().currencySide;
    final currencySymbol = Get.find<PackagesDetailsController>().currencySymbol;
    return Container(
      width: double.infinity,
      padding: const EdgeInsets.all(14),
      decoration: ThemeProvider.cardDecoration(),
        ...
        children: [
          ...
          RichText(
            text: TextSpan(
              children: [
                TextSpan(
                  text: currencySide == 'left' ? '${currencySymbol}${value.packagesDetails.price.toString()}' : '${value.packagesDetails.price.toString()}$currencySymbol',
