...
class ServicesController extends GetxController with GetTickerProviderStateMixin implements GetxService {
  ...
  Future<void> share() async {
    await SharePlus.instance.share(ShareParams(text: '${'Please checkout this salon'.tr} ${salonDetails.name} ${salonDetails.website.toString()}', title: Environments.appName));
  }
