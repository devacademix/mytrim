...
class FindLocationController extends GetxController implements GetxService {
  ...
  void getLocation() async {
    ...
    _determinePosition().then((value) async {
      ...
      String address = [name, subLocality, locality, administrativeArea, postalCode, country].where((part) => part.trim().isNotEmpty && part.trim().toLowerCase() != 'null').join(', ');
      debugPrint(address);
      ...
      parser.saveLatLng(21.5397106, 71.8215543, 'Bhavnagar, Gujarat, India');
      Get.delete<TabsController>(force: true);
      Get.delete<HomeController>(force: true);
      Get.delete<NearController>(force: true);
      Get.delete<CategoriesController>(force: true);
