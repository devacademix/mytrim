...
export class AppComponent {
  ...
  initializeApp() {
    ...
    console.log('%c Copyright and Good Faith Purchasers © 2020-present Saundarya. ', 'background: #222; color: #bada55');
  ...
  openLink(type) {
    if (type == 'eula') {
      window.open('https://saundarya.com/foodiesaagya/eula.html');
    } else {
      window.open('https://saundarya.com/foodiesaagya/privacy.html');
    }
  }
